...
<div class="container">
    <div class="row">
        <div class="col-md-10 mx-auto">
            <h2 class="mb-4">{{ __('Create Subagent') }}</h2>
            ...
            <form method="POST" action="{{ route('subagents.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="p-4 bg-light rounded shadow-sm">
                            ...
                            <div class="mb-3">
                                ...
                                <small class="form-text text-muted">{{ __('Upload a profile photo (JPG, PNG, GIF)') }}</small>
                                @error('photo')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                ...
                <div class="mt-4 text-end">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> {{ __('Create Subagent') }}
                    </button>
                </div>
            </form>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (addButton && container) {
            // Enable the first remove button if there are multiple rows
            updateRemoveButtons();
