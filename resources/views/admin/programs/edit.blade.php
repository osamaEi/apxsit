                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('department') is-invalid @enderror" id="department" name="department" required>
                                        ...
                                        @foreach($departments as $department)
                                            <option value="{{ $department->name }}" {{ old('department', $program->department) == $department->name ? 'selected' : '' }}>
                                                {{ $department->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('degree') is-invalid @enderror" id="degree" name="degree" required>
                                        ...
                                        @foreach($degrees as $key => $value)
                                            <option value="{{ $value->name }}" {{ old('degree', $program->degree) == $value->name ? 'selected' : '' }}>
                                                {{ $value->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('language') is-invalid @enderror" id="language" name="language" required>
                                        ...
                                        @foreach($languages as $key => $value)
                                            <option value="{{ $key }}" {{ old('language', $program->language) == $key ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('shift_type') is-invalid @enderror" id="shift_type" name="shift_type" required>
                                        ...
                                        @foreach($shiftTypes as $key => $value)
                                            <option value="{{ $key }}" {{ old('shift_type', $program->shift_type) == $key ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" min="0" class="form-control @error('before_discount') is-invalid @enderror" id="before_discount" name="before_discount" value="{{ old('before_discount', $program->before_discount) }}" required>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" min="0" class="form-control @error('after_discount') is-invalid @enderror" id="after_discount" name="after_discount" value="{{ old('after_discount', $program->after_discount) }}" required>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" min="0" class="form-control @error('cash_discount') is-invalid @enderror" id="cash_discount" name="cash_discount" value="{{ old('cash_discount', $program->cash_discount ?? 0) }}">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" min="0" class="form-control @error('deposit_payment') is-invalid @enderror" id="deposit_payment" name="deposit_payment" value="{{ old('deposit_payment', $program->deposit_payment ?? 0) }}">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="0.01" min="0" max="100" class="form-control @error('siblings_discount') is-invalid @enderror" id="siblings_discount" name="siblings_discount" value="{{ old('siblings_discount', $program->siblings_discount ?? 0) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('status') is-invalid @enderror" id="status" name="status" required>
                                        ...
                                        @foreach($statuses as $key => $value)
                                            <option value="{{ $key }}" {{ old('status', $program->status) == $key ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
...
$(function() {
    ...
    // Trigger validation on page load to show discount percentage
    validateDiscounts();
});
</script>
@endsection