                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="department" name="department" required>
                                ...
                                <option value="{{ $department->name }}" {{ old('department', $application->department) == $department ? 'selected' : '' }}>
                                    {{ $department->name }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="code" name="code" value="{{ old('code', $application->code) }}" placeholder="Enter application code">
                            @error('code')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="degree" name="degree" required>
                                ...
                                <option value="{{ $degree->name }}" {{ old('degree', $application->degree) == $degree ? 'selected' : '' }}>
                                    {{ $degree->name }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="language" name="language" required>
                                ...
                                <option value="{{ $language }}" {{ old('language', $application->language) == $language ? 'selected' : '' }}>
                                    {{ $language }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="semester" name="semester" required>
                                ...
                                <option value="{{ $semester }}" {{ old('semester', $application->semester) == $semester ? 'selected' : '' }}>
                                    {{ $semester }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="status" name="status" required>
                                ...
                                @foreach(['Pending Review', 'In Progress', 'Approved', 'Rejected'] as $status)
