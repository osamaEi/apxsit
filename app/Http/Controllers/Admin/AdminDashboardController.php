...
class AdminDashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $recentUsers = User::latest()
            ...
            $applicationCompleted = Application::where('status','Completed')->count();
            $studentStats = [
                'totalStudents' => $studentCount,
                'newApplications' => Application::where('status', 'New')->count(),
                'inReviewApplications' => Application::where('status', 'In Review')->count(),
                'pendingDocuments' => Application::where('status', 'Pending Documents')->count(),
